...
// Regles metier communes au serveur et au client (voir public/js/commun.js).
...
/** 450 -> 7.5 (pour les colonnes numeriques des exports Excel) */
...
function semaineISO(date) {
  ...
  const semaine = 1 + Math.round((jeudi - premierJeudi) / (7 * 86400000));
  return { annee, semaine };
}

/**
 * Controles de coherence appliques a une fiche avant soumission puis rappeles
 * au directeur. Chaque anomalie est bloquante ou simplement signalee.
 */
